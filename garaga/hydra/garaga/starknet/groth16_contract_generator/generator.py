...
if __name__ == "__main__":
    ...
    ZKLOGIN_VK_PATH = (
            "hydra/garaga/starknet/groth16_contract_generator/examples/verify_no_sha256.json"
    )

    CONTRACTS_FOLDER = "src/contracts/"  # Do not change this

    FOLDER_NAME = "groth16_zklogin"  # '_curve_id' is appended in the end.
    ...
    # )
    gen_groth16_verifier(
        ZKLOGIN_VK_PATH, CONTRACTS_FOLDER, FOLDER_NAME, ECIP_OPS_CLASS_HASH
    )
